...
const part1Content: Record<string, PracticeAreaContent> = {
  "civil-law": {
    detailedOverview: [
      "Looking for the best civil lawyer in India? NyaySevak connects you with verified civil law advocates across the Supreme Court, 25 High Courts, and 700+ District Courts. Whether you need a civil lawyer for a property dispute, money recovery suit, breach of contract, partition matter, injunction, or specific performance action, our network covers every type of civil litigation under the Code of Civil Procedure, 1908 (CPC). Civil law in India governs disputes between individuals, organizations, and institutions over rights, obligations, and liabilities — and our advocates have decades of combined experience handling these matters end-to-end. Book a free case assessment in 60 seconds.",
  ...
  "legal-notices": {
    ...
    faqs: [
      ...
      { question: "How much does it cost to send a legal notice in India?", answer: "The cost of a legal notice depends on how much work sits behind it — a straightforward cheque-bounce or recovery notice is a different exercise from a notice that has to set out a complex contractual or matrimonial history and anticipate the reply. We do not publish fee amounts, because Bar Council rules restrict advocate fee advertising; the fee is quoted upfront and agreed before drafting begins, and your first step is a free case assessment." }
    ],
    relevantCourts: [
