...
export const practiceAreas: PracticeArea[] = [
  ...
  },
  {
    ...
    letter: "LN",
    title: "Legal Notices",
    description: "Drafting, sending, and replying to legal notices across every dispute type in India",
    featured: true,
    services: [
      "Cheque bounce notice under Section 138 NI Act",
      "Eviction notice to tenant (with state Rent-Control compliance)",
      "Defamation notice (civil and criminal)",
      "Recovery notice for unpaid dues / loans / invoices",
      "Consumer Protection Act statutory notice",
      "Notice under Section 80 CPC against government bodies",
      "Divorce / matrimonial notice (Section 13 HMA grounds)",
      "Employment / wrongful termination notice",
      "Reply to a legal notice — drafting and dispatch",
      "RTI notice and second appeal under RTI Act 2005",
    ],
  },
  {
