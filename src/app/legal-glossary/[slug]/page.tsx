      ...
      <section className="pb-16 lg:pb-24">
        <div className="mx-auto max-w-3xl px-6 lg:px-8">
          ...
          <LeadCTA
            ...
            subtext="Definitions describe the framework — your case lives in its facts. Talk to a Bar-Council-verified advocate. Case assessment is free and comes with no obligation; callback usually within 24 hours."
