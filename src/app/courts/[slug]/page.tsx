...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  if (tr) return {
    ...
    twitter: {
      ...
      description: `Expert tribunal advocates across India. Case assessment.`,
    },
  };
          ...
          <div className="gradient-border-card rounded-2xl p-px">
            <div className="glass-card !rounded-2xl p-8 sm:p-12">
              ...
              <p className="mx-auto mt-4 mb-8 max-w-lg text-sm text-gray-400 leading-relaxed">
                Connect with verified lawyers {hc ? `at the ${hc.name}` : dc ? `across all ${dc.districts.length} district courts in ${dc.state}` : `for ${tr?.title} tribunal matters`}. Book a case assessment today.
              </p>
