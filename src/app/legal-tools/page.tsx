    ...
    <main className="min-h-screen">
      ...
      <FaqBlock
        ...
        faqs={[
          ...
          { question: "Can a lawyer help interpret the results?", answer: "Yes — book a free case assessment and a verified lawyer will explain how the numbers apply to your specific matter." },
        ]}
      />
    </main>
  );
