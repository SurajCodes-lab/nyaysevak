...
export const metadata: Metadata = {
  ...
  description:
    "Find the best lawyers in India across 29 practice areas. Criminal lawyer, divorce lawyer, property lawyer, corporate lawyer, cyber crime lawyer, bail lawyer, CBI/ED/NDPS defense, consumer protection, IP, tax & more. Verified advocates with paid case assessment.",
  keywords:
  ...
  openGraph: {
    ...
    description:
      "Find verified lawyers across 29 practice areas. Criminal, civil, family, corporate, IP, tax, cyber crime, CBI, ED, NDPS & more. Paid case assessment available.",
    type: "website",
