...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    title: metaTitle(`${v.primary} in India — Case Assessment`),
    description: metaDescription([
      `Verified ${primaryLower}s across India's Supreme Court, High Courts and district courts.`,
      "Free case assessment, fees agreed upfront.",
      `${area.services.slice(0, 2).join(", ")}.`,
    ]),
    keywords: [
          ...
          <div className="gradient-border-card">
            <div className="bg-dark-deep rounded-[calc(1.25rem-1.5px)] p-8 sm:p-10 lg:p-14">
              ...
              <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4">
                ...
                <WhatsAppLink
                  message={`Hi, I need help with ${area.title}`}
                  source="practice_area_page"
                  context={area.title}
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 sm:mt-12 text-center">
            ...
            >
              ...
              Browse All {practiceAreas.length} Practice Areas of Indian Law
            </Link>
          </div>
        </div>
      </section>
