...
const serviceContent: Record<string, { overview: string; benefits: string[]; process: string[]; whyChoose: string[]; faqs: { q: string; a: string }[] }> = {
  ...
  "find-hire-lawyers": {
    ...
    faqs: [
      ...
      { q: "How are fees decided?", a: "Your matched lawyer shares their fee structure — consultation, retainer, and per-appearance — transparently before you commit. There is no online payment on NyaySevak; you agree and pay fees directly with the lawyer. Your first consultation is free." },
