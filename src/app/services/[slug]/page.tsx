...
const serviceContent: Record<string, { overview: string; benefits: string[]; process: string[]; whyChoose: string[]; faqs: { q: string; a: string }[] }> = {
  "lawyer-consultation": {
    ...
    whyChoose: ["1,000+ verified advocates across all 26 practice areas", "Average response time under 2 hours for urgent matters", "Consultations in 15+ Indian languages including Hindi, Tamil, Bengali", "4.8/5 average client satisfaction rating", "Confidential and encrypted communication", "Free first consultation for new clients"],
    faqs: [
