...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "India's most comprehensive legal services platform. Lawyer consultation, document services, corporate advisory & more. Free case assessment available.",
