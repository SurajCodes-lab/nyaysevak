...
export const metadata: Metadata = {
  ...
  description:
    "Best legal services in India for individuals & businesses. Online lawyer consultation, find & hire verified advocates, document drafting, corporate legal advisory, compliance management, contract management, IP registration, litigation support. Paid case assessment available.",
  keywords:
    "legal services India, lawyer consultation online, find lawyer near me, best advocate India, corporate legal advisory, compliance management, contract management, IP management, B2B legal services, B2C legal services, online lawyer India, legal help online, hire lawyer online, verified lawyer India, affordable legal services, paid case assessment",
  alternates: { canonical: "https://www.nyaysevak.com/services" },
  openGraph: {
    title: "Legal Services India - B2B & B2C Solutions | NyaySevak",
    description: "India's most comprehensive legal services platform. Lawyer consultation, document services, corporate advisory & more. Paid case assessment available.",
