...
const market: StatRow[] = [
  ...
  { metric: "Average fee — first lawyer consultation, metros", value: "₹500–₹2,500", asOf: "2025-26", source: "Editorial estimate from market scan", notes: "Free case assessment is offered by NyaySevak and several other platforms." },
    ...
    <main className="bg-dark-deep text-white">
      ...
      <div className="mx-auto max-w-5xl px-4 py-20 md:py-28">
        ...
        <section className="mt-16 rounded-2xl border border-white/10 bg-white/[0.03] p-6">
          <h2 className="text-xl font-semibold text-gold">Need a lawyer? First step is a free case assessment.</h2>
