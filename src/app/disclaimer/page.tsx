      ...
      <section className="py-16 lg:py-24">
        <div className="mx-auto max-w-4xl px-6 lg:px-8">
          <div className="space-y-14">
            {/* Important Notice */}
            <div className="rounded-xl border border-gold/20 bg-gold/[0.04] p-8">
              <h2 className="mb-4 text-xl font-heading font-bold text-gold-dark sm:text-2xl">
                Important Notice
              </h2>
            ...
            <div>
              ...
              <ul className="mt-4 list-disc space-y-2 pl-6 text-gray-500">
                <li>Any information you provide through the Platform is not protected by attorney-client privilege</li>
                <li>No legal professional on the Platform has any obligation to represent you or act on your behalf</li>
                <li>Communications through the Platform are not confidential legal communications</li>
                <li>NyaySevak does not vet, endorse, or take responsibility for any legal advice provided by professionals on the Platform</li>
              </ul>
              <p className="mt-4 text-gray-600 leading-relaxed">
            ...
            <div>
              ...
              <ul className="mt-4 list-disc space-y-2 pl-6 text-gray-500">
                ...
                <li>Damages arising from the conduct of any legal professional or third party on the Platform</li>
                <li>Damages arising from any content, information, or advice obtained from the Platform</li>
                <li>Damages arising from unauthorized access to or alteration of your data or transmissions</li>
                <li>Damages arising from the outcome of any legal matter or proceeding</li>
                <li>Damages arising from errors, mistakes, or inaccuracies in the content</li>
