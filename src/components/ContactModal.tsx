    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center">
      ...
      <div role="dialog" aria-modal="true" aria-labelledby="contact-modal-title" className="relative z-10 w-[95%] max-w-lg max-h-[90vh] overflow-y-auto rounded-2xl border border-white/10 bg-dark shadow-2xl shadow-black/50 animate-modalSlideUp">
        ...
        <div className="px-6 py-6 sm:px-8 sm:py-8">
          {submitted ? (
            <div role="status" aria-live="polite" className="flex flex-col items-center justify-center py-6 text-center">
              <div className="mb-5 flex h-20 w-20 items-center justify-center rounded-2xl icon-gold gold-glow-md">
                <CheckCircle2 className="h-10 w-10 text-black" strokeWidth={1.5} />
              </div>
              <h4 className="text-xl font-heading font-bold text-white heading-glow">Request received</h4>
              <p className="mt-2 text-sm text-gray-300 max-w-sm leading-relaxed">
                A verified NyaySevak advocate will review your matter and call you back — usually within 2 hours during working hours.
              </p>
              <p className="mt-5 mb-3 text-[11px] uppercase tracking-[0.2em] text-gold/70 font-semibold">Need help right now?</p>
              <div className="flex flex-col sm:flex-row items-center gap-3 w-full max-w-sm">
                <a
                  href="tel:+919868666715"
                  className="flex-1 w-full inline-flex items-center justify-center gap-2 rounded-xl border border-gold/40 px-5 py-3 text-sm font-semibold uppercase tracking-widest text-gold hover:bg-gold/10 transition-all duration-300"
                >
                  <Phone className="h-4 w-4" strokeWidth={2} /> Call now
                </a>
                <a
                  href="https://wa.me/919868666715?text=Hi%2C%20I%20just%20submitted%20a%20consultation%20request%20on%20NyaySevak."
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 w-full inline-flex items-center justify-center gap-2 rounded-xl bg-[#25D366] px-5 py-3 text-sm font-semibold uppercase tracking-widest text-white hover:shadow-lg hover:shadow-[#25D366]/30 transition-all duration-300"
                >
                ...
                {trustBadges.map((badge) => {
                  ...
                  return (
                    <div key={badge.label} className="flex items-center gap-2">
                      <div className="seal-badge h-7 w-7 rounded-full flex items-center justify-center">
                        <BadgeIcon className="h-3.5 w-3.5 text-gold" strokeWidth={1.5} />
                      </div>
