...
export default function Contact({ headingLevel = "h2" }: { headingLevel?: "h1" | "h2" } = {}) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Persist the success state with next-step CTAs instead of silently resetting.
    } catch {
      ...
      <div className="flex flex-col lg:flex-row min-h-[80vh]">
        ...
        <div className="relative flex flex-col justify-center bg-dark-deep px-4 sm:px-6 py-16 sm:py-20 lg:w-[45%] lg:px-10 xl:px-16 lg:py-24 overflow-hidden dark-section-depth">
          ...
          <div className="relative z-10">
            ...
            <Heading className="text-2xl sm:text-3xl lg:text-4xl font-heading font-bold tracking-tight text-white heading-glow">
